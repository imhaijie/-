...
export function TeamBuildingPhase() {
  ...
  return (
    <div className="flex flex-1 flex-col px-4 py-4 lg:flex-row lg:gap-6 lg:px-6">
      {/* Left side: Timer and info (desktop) / Main content (mobile) */}
      ...
      <div className="mt-4 flex flex-1 flex-col lg:mt-0">
        ...
        <div className="grid flex-1 auto-rows-min grid-cols-2 gap-2 lg:grid-cols-3 xl:grid-cols-4">
          {state.players.map((player) => {
            ...
            return (
              <button
                ...
                className={`relative flex items-center gap-3 rounded-lg border-2 px-3 py-3 text-left transition-all lg:px-4 ${
                  isSelected
              ...
              >
                <div
                  className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-lg font-bold lg:h-12 lg:w-12 ${
                    isSelected
                      ? "bg-primary text-primary-foreground"
        ...
        {/* Submit button */}
        <div className="sticky bottom-4 mt-4 lg:relative lg:bottom-0">
          <Button
            className="w-full"
            size="lg"
