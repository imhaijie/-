      ...
      <SheetContent className="w-[340px] bg-card sm:w-[400px]">
        ...
        <div className="mt-4 space-y-4 overflow-y-auto pr-1" style={{ maxHeight: "calc(100dvh - 120px)" }}>
          ...
          <div className="flex gap-3">
            <div className="flex flex-1 items-center gap-2 rounded-md bg-[hsl(210_80%_55%/0.08)] px-3 py-2">
              <Shield className="h-4 w-4 text-good" />
              <span className="text-sm font-medium text-good">
                {state.goodWins}
              </span>
            </div>
            <div className="flex flex-1 items-center gap-2 rounded-md bg-[hsl(0_72%_51%/0.08)] px-3 py-2">
              <Skull className="h-4 w-4 text-evil" />
              <span className="text-sm font-medium text-evil">
                {state.evilWins}
              </span>
            </div>
          </div>
              ...
              >
                ...
                <div className="mb-2 flex items-center justify-between">
                  ...
                  >
                    ...
                    {quest.failCount > 0 && ` (${quest.failCount}失败)`}
                  </span>
                </div>
